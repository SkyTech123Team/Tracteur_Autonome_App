...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupRedirectText = findViewById(R.id.signeupRedirectText);
        ...
        // Set click listener for the sign-up redirect text
        signupRedirectText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, SigneUpActivity.class));
            }
        });
    ...
    /**
     * Show the forgot password dialog for resetting password via email.
     */
    ...
    /**
     * Navigate to MainActivity and finish the current activity.
     */
