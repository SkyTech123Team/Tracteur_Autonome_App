...
public class UploadImageFragment extends Fragment {
    ...
    private String ipAddress = "192.168.0.199"; // Remplacez cette valeur par l'adresse IP de votre Raspberry Pi
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSIONS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(getContext(), "Les permissions sont nécessaires pour utiliser cette application", Toast.LENGTH_SHORT).show();
            }
        }
    }
